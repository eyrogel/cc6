...
def main():
    ...
    # Add the starting position to the queue along with an empty path
    node_queue.append([pacman_start_x, pacman_start_y, []])

    # Explore nodes in the queue
    while node_queue:
        x, y, path = node_queue.pop(0)
        ...
        for move in movements:
            ...
            if game_board[next_x][next_y] == "-" or game_board[next_x][next_y] == ".":
                ...
                node_queue.append([next_x, next_y, current_path])
